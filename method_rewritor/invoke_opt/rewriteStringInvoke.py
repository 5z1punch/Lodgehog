...
MAXREF = len(staticMethods) + len(virtualMethods)
def rewrite(line):
    global virtualMethods, originClass, staticMethods
    tline = line.lstrip()
    if tline.startswith("invoke-static"):
        ...
        for vm in virtualMethods:
            ...
            if invokeCode in line:
                ...
                return True, rewriteCode.replace("invoke-virtual", "invoke-static"), vm
    return False, None